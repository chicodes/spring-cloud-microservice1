package com.webzifi.app.ws.ui.controller;
...
import com.webzifi.app.ws.exceptions.UserServiceException;
import com.webzifi.app.ws.ui.model.request.UpdateDetailsRequestModel;
...
public class UserController {
	...
	@GetMapping
	public String getUsers(@RequestParam(value="page", defaultValue="1") int page, @RequestParam(value="limit", defaultValue="4") int limit) {
